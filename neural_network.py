...
first_path = Conv2D(8, (3,3), padding='same', activation='relu')(network_input)
first_path = Conv2D(16, (3,3), padding='same', activation='relu')(first_path)
second_path = Conv2D(16, (3,3), padding='same', activation='relu')(network_input)
second_path = Conv2D(16, (3,3), padding='same', activation='relu')(second_path)
third_path = Conv2D(16, (3,3), padding='same', activation='relu')(network_input)
third_path = Conv2D(32, (3,3), padding='same', activation='relu')(third_path)

inception_output = concatenate([first_path, second_path, third_path], axis = 3)

network = Conv2D(32, (3, 3), activation='relu', padding='same')(inception_output)
...
network = Conv2D(256, (3, 3), activation='tanh', padding='same')(network)
network = MaxPooling2D((2,2))(network)
network = Conv2D(512, (3, 3), activation='relu', padding='same')(network)
network = Conv2D(512, (3, 3), activation='tanh', padding='same')(network)
network = Conv2D(512, (3, 3), activation='tanh', padding='same')(network)
